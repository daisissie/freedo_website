...
window.SITE_I18N.zh = {
  ...
  tw2_num: '02 · 认识', tw2_zh: '认识世界', tw2_en: '空间理解', tw2_stat_val: '精准理解', tw2_stat_lbl: '不同语义',
  tw3_num: '03 · 走遍', tw3_zh: '走遍世界', tw3_en: '空间决策', tw3_stat_val: '智能',   tw3_stat_lbl: '决策',
  ...
  sc1_tag: '火灾救援',  sc1_title: '城市灾害',      sc1_desc: '生成建筑内部火势蔓延、烟雾扩散的物理仿真数据，训练消防无人机与应急机器人的自主决策能力。',   sc1_f1: '火势仿真',   sc1_f2: '烟雾识别',   sc1_f3: '应急规划',
  sc2_tag: '洪涝防控',  sc2_title: '水务水利',      sc2_desc: '浪高、水位、流速、淹没面积，物理精确的水文仿真，为防洪巡检无人机提供完整训练环境。',           sc2_f1: '水文推演',   sc2_f2: '淹没预测',   sc2_f3: '调度规划',
  sc3_tag: '国防安全',  sc3_title: '卫星',              sc3_desc: '物理参数、力学属性、爆破仿真，在数字世界中训练自主无人系统，实现威胁识别与态势研判。',           sc3_f1: '物理仿真',   sc3_f2: '爆破模拟',   sc3_f3: '威胁分析',
  sc4_tag: '智慧农业',  sc4_title: '农业',              sc4_desc: '树种识别、产量计算、作物空间规划，空间数据赋能农业无人机实现真正的自主化精细作业。',             sc4_f1: '树种识别',   sc4_f2: '产量计算',   sc4_f3: '路径规划',
  sc5_tag: '自主系统',  sc5_title: '环境', sc5_desc: '材质识别、发射率感知、热能辐射仿真，助力自动驾驶与工程机器人在复杂环境下的精准决策。',         sc5_f1: '热能辐射',   sc5_f2: '目标定位',   sc5_f3: '合成数据集',
  sc6_tag: '文旅文保',  sc6_title: '文旅文保',       sc6_desc: '裂痕识别、损毁评估、风格化视频生成，空间智能为文物保护与沉浸式文旅带来全新可能。',             sc6_f1: '损毁识别',   sc6_f2: '风格生成',   sc6_f3: '自主巡检',
  ...
  carrier3_title: '智能眼镜', carrier3_desc: '人机协同的空间理解界面，实时叠加空间决策层',
  carrier4_title: '穿戴设备',     carrier4_desc: '采集人体与环境交互的真实空间数据，为智能体提供高保真的训练样本，适配复杂场景下的自主决策需求。',
